...
<div class="modal fade" id="editProfileModal" tabindex="-1">
    ...
    Route::get('/reservation-requests/{id}', [App\Http\Controllers\AdminReservationChangeController::class, 'show'])->name('reservation-requests.show');
    Route::post('/reservation-requests/{id}/approve', [App\Http\Controllers\AdminReservationChangeController::class, 'approve'])->name('reservation-requests.approve');
    Route::post('/reservation-requests/{id}/reject', [App\Http\Controllers\AdminReservationChangeController::class, 'reject'])->name('reservation-requests.reject');
    Route::get('/reservation-requests/pending-count', [App\Http\Controllers\AdminReservationChangeController::class, 'getPendingCount'])->name('reservation-requests.pending-count');
...
// Reservation change requests (for authenticated users)
Route::middleware('auth')->group(function () {
    Route::post('/reservation-change-requests/{reservationId}', [App\Http\Controllers\ReservationChangeController::class, 'store'])->name('reservation-change-requests.store');
    Route::get('/reservation-change-requests/{reservationId}/status', [App\Http\Controllers\ReservationChangeController::class, 'getReservationPendingRequest'])->name('reservation-change-requests.status');
    Route::delete('/reservation-change-requests/{id}', [App\Http\Controllers\ReservationChangeController::class, 'cancelRequest'])->name('reservation-change-requests.cancel');
});
